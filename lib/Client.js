...
RealtimetrainsClient.prototype.getLocationList = function (query) {
  ...
  if (query.hasOwnProperty('toStation')) {
    ...
    return this.axios.get('/json/search/' + query.station + '/to/' + query.toStation)
  }
  if (query.hasOwnProperty('date')) {
    ...
    if (query.hasOwnProperty('time')) {
      ...
      return this.axios.get('/json/search/' + query.station + '/' + query.date + '/' + query.time)
    } else {
      return this.axios.get('/json/search/' + query.station + '/' + query.date)
    }
  } else {
    return this.axios.get('/json/search/' + query.station)
  }
}
